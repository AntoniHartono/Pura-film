...
<div id="kekiri">           <?php
                $url=array('controller'=>'Tvasia','action'=>'')+$this->request->params['pass'];
...
<table class="table table-bordered">
    <thead>
        ...
        <tbody>
        <?php foreach ($tvasias as $items) {

            if($items['Tvasia']['judul'] == 'Tv Series Asia'){
            # code...
         ?>
        <tr>
            <?php 
            ?>
            <td><?php echo $items['Tvasia']['judul']; ?></td>
            <td><?php echo $items['Tvasia']['cast']; ?></td>
            <td><?php echo $items['Tvasia']['genre']; ?></td>
            <td><?php echo $items['Tvasia']['episode'];?>
            </td>
  <td><?php echo $items['Tvasia']['tahun']; ?></td>
            <td><?php echo $items['Tvasia']['subtitle'];?>
            </td>
        </tr>
        <?php }} ?>  
    </tbody>
