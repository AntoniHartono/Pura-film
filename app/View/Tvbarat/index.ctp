<div class="header">
            ...
            <div id="navigation">
                <div class="dropdown"> <a href="purafilm.">Home</a></div>
...
<div id="kekiri">           <?php
                $url=array('controller'=>'Tvbarat','action'=>'')+$this->request->params['pass'];
...
<table class="table table-bordered">
    <thead>
        ...
        <tbody>
        <?php foreach ($tvbarats as $items) {

            if($items['Tvbarat']['judul'] == 'Tv Series Barat'){
            # code...
         ?>
        <tr>
            <?php 
            ?>
            <td><?php echo $items['Tvbarat']['judul']; ?></td>
            <td><?php echo $items['Tvbarat']['cast']; ?></td>
            <td><?php echo $items['Tvbarat']['genre']; ?></td>
            <td><?php echo $items['Tvbarat']['episode'];?>
            </td>
  <td><?php echo $items['Tvbarat']['tahun']; ?></td>
            <td><?php echo $items['Tvbarat']['subtitle'];?>
            </td>
        </tr>
        <?php }} ?>  
    </tbody>
